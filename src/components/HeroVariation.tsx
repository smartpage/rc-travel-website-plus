    ...
    return (
      <Section sectionId="hero" id="home">
        <div className="text-center space-y-6 sm:space-y-8 max-w-4xl mx-auto">
          ...
          {/* Skeleton for Avatar */}
          <div className="hidden sm:flex relative justify-center mt-4 mb-6">
  ...
  return (
    <Section sectionId="hero" id="home" backgroundImageUrl={hero.backgroundImageUrl}>
      ...
      <div className="text-center space-y-6 sm:space-y-8 max-w-4xl mx-auto">
        ...
        />
        <div className="flex flex-row items-center justify-start gap-4 sm:block mt-2 mb-4 sm:mb-0">
          ...
          <p className="text-lg sm:text-xl text-white/90 sm:mx-auto leading-tight sm:leading-relaxed flex-1 text-left sm:text-center">
            {hero.description}
          </p>
        </div>
        ...
        <div className="flex justify-center mt-4 sm:mt-0">
          <Button 
            ...
            className="bg-cyan-700 hover:bg-cyan-800 text-white px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg font-normal rounded-xl transition-all duration-300 shadow-none"
          >
            {hero.ctaText}
          </Button>
        </div>
